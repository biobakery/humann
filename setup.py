...
setuptools.setup(
    ...
    entry_points={
        'console_scripts': [
            # the main humann2 driver script
            ...
            'humann2_databases = humann2.tools.databases:main',
            'humann2_filter_table = humann2.tools.filter_table:main',
            ...
            'humann2_relative_expression = humann2.tools.relative_expression:main',
            ...
            'humann2_unpack_pathways = humann2.tools.unpack_pathways:main',
            # the test driver script
